...
//get the total amount pledged for all games using reduce
//and how much money has been raised
const totalPledged = GAMES_JSON.reduce((sum, game) => sum + game.pledged, 0);
const totalGames = GAMES_JSON.length;

// create a string that explains the number of unfunded games using the ternary operator
const descriptionText = `A total of $${totalPledged.toLocaleString()} has been raised for ${totalGames} ${
